  ...
  return (
    <section className="dashboard-grid">
      <div className="dashboard-left">
        ...
        <p className="muted">
          Bạn có {stats.upcomingCount || 0} lịch hẹn sắp tới và sức khỏe đang ổn định.
        </p>
      ...
      {showMetricModal ? (
        <div className="modal-backdrop">
          <form className="metric-modal" onSubmit={submitMetrics}>
            ...
            <p className="muted">
              Mốc tham khảo: nhịp tim nghỉ ngơi người lớn 60-100 bpm (Mayo Clinic), huyết áp mục tiêu
              khoảng dưới 120/80 mmHg (Cleveland Clinic), đường huyết đói thường 3.9-5.5 mmol/L.
            </p>
            <div className="stack-sm">
